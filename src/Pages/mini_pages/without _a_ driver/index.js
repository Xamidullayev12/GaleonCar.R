...
import without_a_drive_bg from "../../../Components/images/carParc/business/without-a-car-bg.png"
...
export default function without_a_driver() {
    return (
        <section id="without_driver" className="bg-black">
            <Main mainImg={without_a_drive_bg} mainTitle={"БЕЗ ВОДИТЕЛЯ"}/>
            <Carousel/>
        </section>
    )
}
    ...
    return (
        <div>
            ...
            <div className="relative lg:py-20 md:py-16 py-10">
                ...
                <div className="w-96 md:h-[406px] relative top-24 lg:absolute bottom-3 right-0 top-bottom-20 lg:w-3/6 ml:w-7/12 w-10/12  bg-gray-900 mx-auto">
                    <div className="relative bottom-5 left-5 md:w-100 max-w-md border border-[#EDC5A2] lg:px-8 ml:px-4 lg:py-8 md:py-3 ">
                        ...
                        <div className="flex  my-2">
                            ...
                            <div className="mx-2">
                                <p className="font-bold text-gray-300 my-0.5">Аренда</p>
                                <p className="tetx-xs text-gray-400 my-0.5">от 21 года</p>
                            </div>
                        </div>
                        <div className="flex  my-2">
                            <span className="text-white"><BiTimeFive size={18}/></span>
                            <div className="mx-2">
                                <p className="font-bold text-gray-300 my-0.5">Стаж</p>
                                <p className="tetx-xs text-gray-400 my-0.5">не менее 2 лет</p>
                            </div>
                        </div>
                        <div className="flex  my-2">
                        ...
                        <div className="flex  my-2">
                            <span className="text-white"><IoIosTimer size={20}/></span>
                            <div className="mx-2">
                                <p className="font-bold text-gray-300 my-0.5">Цена</p>
                                <p className="tetx-xs text-gray-400 my-0.5">фиксированная</p>
                            </div>
                        </div>
                        <div className="flex  my-2">
                            <span className="text-white"><IoIosTimer size={20}/></span>
                            <div className="mx-2">
                                <p className="font-bold text-gray-300 my-0.5">Управление</p>
                                <p className="tetx-xs text-gray-400 my-0.5">возможна передача</p>
                            </div>
                        </div>
                    </div>
                </div>
